...
st.sidebar.info("""
    The aim of this project is to create an interactive Covid-19. This app is maintained by Team number 6 of the Open Source course for the second semester of Master 1 Digital Sciences.
